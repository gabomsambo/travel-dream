...
> During the research process, spawn subagents as needed for deep research. We optimize for chance of success, not speed.

1. **Codebase Analysis in depth**
   - Search the codebase for similar features/patterns
   - Identify all the necessary files to reference in the PRP
   - Note all existing conventions to follow (check component patterns, API route patterns, DB query patterns)
   - Check existing test patterns for validation approach
   - Read CLAUDE.md and LOCAL_SETUP.md if they exist
...
### Step 5: Think Hard Before Writing

After research completion, plan your PRP:
